    ...
    return (
        <div className={styles.home_box}>
            ...
            <div className={styles.btns_box}>
                <button onClick={e => { handleClick(e) }} className='elementNB'>Reload Recipes</button>
                <button onClick={crear_recetas_boton} className='elementNB'>Create Recipe</button>
                {<select onChange={handle_ordenar_por_nombre}>
                    <option value='default' className='elementNB' hidden>Order by Name</option>
                    <option value='ASC'>A-Z</option>
                    <option value='DESC'>Z-A</option>
                </select>}
                {<select onChange={handle_ordenar_por_puntuacion}>
                    <option value='default' className='elementNB' hidden>Order by Score</option>
                    <option value='ASC'> Min Value</option>
                    <option value='DESC'> Max Value</option>
                </select>}
